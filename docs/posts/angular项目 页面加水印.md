...
//初始化
    setTimeout(() => {
      setInterval(()=>{
        let text1 = { watermark_txt: window.localStorage.userName+window.localStorage.userPhone.substr(window.localStorage.userPhone.length-4), watermark_fontsize: '16px'};
