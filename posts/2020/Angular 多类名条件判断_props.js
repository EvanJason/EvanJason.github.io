...
export default {
    ...
    'outputPath': "posts/2020/Angular 多类名条件判断.html",
    'title': "Angular 多类名条件判断",
    'content': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<h1>Angular 多类名条件判断</h1>\n<pre class="language-html"><code class="language-html">[ngClass]="{bg1: data.oneLtv >3,bg2: data.oneLtv >1 &amp;&amp; data.oneLtv&lt;=3,bg3: data.oneLtv >0.5 &amp;&amp; data.oneLtv &lt;=1,bg4: data.oneLtv >0 &amp;&amp; data.oneLtv &lt;=0.5}"\n</code></pre>'
        } }),
    ...
    'contentTitle': React.createElement("h1", { key: "0" }, "Angular \u591A\u7C7B\u540D\u6761\u4EF6\u5224\u65AD"),
    'contentBody': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<pre class="language-html"><code class="language-html">[ngClass]="{bg1: data.oneLtv >3,bg2: data.oneLtv >1 &amp;&amp; data.oneLtv&lt;=3,bg3: data.oneLtv >0.5 &amp;&amp; data.oneLtv &lt;=1,bg4: data.oneLtv >0 &amp;&amp; data.oneLtv &lt;=0.5}"\n</code></pre>'
        } }),
    'toc': null,
    'author': "深海如梦",
    'contributors': [
